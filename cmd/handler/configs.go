...
import (
	...
	config "HFtest-platform-jeronimofalavina-tst/cmd/models"
...
func QueryConfigs(c *gin.Context) {
	...
	var matchConfigs []config.Config
	var keys []string
...
func getConfigByName(name string) (*config.Config, int, error) {
